...
void Level::render() {
  ...
  for (uint8_t i = 0; i < 16; i++)
    arduboy.drawBitmap(i * 8, 6 * 8, &bmp_lake[((frame >> 3) % 2) * 8], 8, 8);

  for (uint8_t i = 0; i < 13; i++)
    arduboy.drawBitmap(i * 8, 5 * 8, bmp_ground, 8, 8);
  arduboy.drawBitmap(13 * 8, 4 * 8, &bmp_river[((frame >> 2) % 3) * 8], 8, 8);
  arduboy.drawBitmap(13 * 8, 4 * 8, bmp_bridge, 8, 8);
  arduboy.drawBitmap(2 * 8, 1 + 4 * 8, &bmp_man[((frame >> 3) % 4) * 8], 8, 8);
  arduboy.drawBitmap(13 * 8, 5 * 8, &bmp_river[((frame >> 2) % 3) * 8], 8, 8);
  for (uint8_t i = 14; i < 16; i++)
    arduboy.drawBitmap(i * 8, 5 * 8, bmp_ground, 8, 8);

  arduboy.drawBitmap(0 * 8, 2 * 8, bmp_house, 16, 16);
  arduboy.drawBitmap(2 * 8, 2 * 8, bmp_sherif, 16, 16);
